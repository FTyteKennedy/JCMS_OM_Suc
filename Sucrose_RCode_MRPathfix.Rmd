...
```{r}
# Specify the text to exclude
# excluded_strains <- c("B6SJL-Tg(5xFAD) HEMI", "B6SJL-Tg(5xFAD) NCAR", "C57BL/6J", "C57BL/6NJ", "DBA/2J", "DBA/1J") # I removed this for xxx reasons 
excluded_strains <- c("B6SJL-Tg(5xFAD) HEMI", "B6SJL-Tg(5xFAD) NCAR", "C57BL/6NJ", "DBA/1J")
